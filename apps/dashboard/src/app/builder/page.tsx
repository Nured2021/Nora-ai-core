...
const EXAMPLES = [
  ...
  'build a PostgreSQL database schema for e-commerce',
  ...
  return (
    <div className="flex flex-col h-full p-4 gap-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-nora-muted">NORA-BUILDER + NORA-CODE + NORA-ARCH</span>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {EXAMPLES.map((ex) => (
          <span
            ...
            onClick={() => {
              // Copy to clipboard / trigger command input
            }}
          >
            {ex}
          </span>
      ...
      <CommandInput onResult={handleResult} />
